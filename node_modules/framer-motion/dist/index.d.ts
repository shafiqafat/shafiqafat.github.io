...
import { TransformPoint, Easing, Point } from 'motion-utils';
...
type OnScroll = (progress: number, info: ScrollInfo) => void;
...
declare function scroll(onScroll: OnScroll | AnimationPlaybackControls, { axis, source, container, ...options }?: ScrollOptions): VoidFunction;
