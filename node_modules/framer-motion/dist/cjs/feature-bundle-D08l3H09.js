    ...
    constructor(event, handlers, { transformPagePoint, contextWindow = window, dragSnapToOrigin = false, distanceThreshold = 3, element, } = {}) {
        ...
        this.updatePoint = () => {
            ...
            if (!isPanStarted && !isDistancePastThreshold)
                return;
            const { point } = info;
            this.history.push({ ...point, timestamp: motionDom.time.now() });
...
function getVelocity(history, timeDelta) {
    ...
    const seconds = motionUtils.millisecondsToSeconds(lastPoint.timestamp - timestampedPoint.timestamp);
    if (seconds === 0) {
        return { x: 0, y: 0 };
    }
...
class VisualElementDragControls {
    ...
    snapToCursor({ clientX, clientY }) {
        ...
        motionDom.eachAxis((axis) => {
            ...
            axisValue.set((axisValue.get() || 0) + cursor[axis] - motionDom.mixNumber(min, max, 0.5));
        });
    }
    /**
...
//# sourceMappingURL=feature-bundle-D08l3H09.js.map
