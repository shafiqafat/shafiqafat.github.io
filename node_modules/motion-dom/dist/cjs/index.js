...
function resolvePhysics(value, canBeZero) {
    ...
    if (process.env.NODE_ENV !== "production") {
        motionUtils.warning(value === undefined, "Spring stiffness and mass must be positive, damping 0 or greater", "spring-invalid-physics");
    }
    return undefined;
}
...
function spring(optionsOrVisualDuration = springDefaults.visualDuration, bounce = springDefaults.bounce) {
    ...
    const generator = {
        ...
        retarget: (keyframes, newVelocity) => {
            ...
            s.velocity = isTimeDefined ? 0 : -motionUtils.millisecondsToSeconds(newVelocity);
...
function keyframes({ duration = 300, keyframes: keyframeValues, times, ease = "easeInOut", }) {
    ...
    const easingFunctions = motionUtils.isEasingArray(ease)
        ...
        : motionUtils.easingDefinitionToFunction(ease) || motionUtils.easeInOut;
    /**
     * This is the Iterator-spec return value. We ensure it's mutable rather than using a generator
     * to reduce GC during animation.
     */
