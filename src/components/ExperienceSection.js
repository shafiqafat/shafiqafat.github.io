...
const ExperienceSection = {
  ...
  data() {
    return {
      experiences: [
        {
          logo: "src/assets/images/accelosys.png",
          title: "Web Developer Intern at Accelosys",
          company: "Accelosys",
          period: "Feb 2026 - Present",
          description: "As an Web Developer Intern at Accelosys, I collaborated with the development team to support design, development, and maintenance of web applications. I contribute to frontend implementation, assist in improving existing features, and apply modern web development technologies and best practices. Through hands-on project involvement, I continuously strengthen my understanding of clean code structure, usability priciples, and collaborative development workflows."
        },
        {
